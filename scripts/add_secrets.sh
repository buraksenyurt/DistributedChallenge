...
add_or_update_secret "Development" "FtpServerAddress" "localhost:21"
add_or_update_secret "Development" "FtpUsername" "system_user"
add_or_update_secret "Development" "FtpPassword" "P@ssw0rd"